...
/*   Updated: 2025/04/30 01:37:19 by nifromon         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	cub_rendering_manager(t_game *game)
{
	...
	else if (game->status == 0)
	{
		...
		cub_render_map2d(game, &game->map, &game->map_const, cub_convert_glrgb(255, 255, 255, 1));
		cub_render_sprites(game, &game->sprite, &game->player);
	}
